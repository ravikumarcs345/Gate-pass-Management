...
export default function UpdateProduct() {
    ...
    }, [isProductUpdated, navigate, error, dispatch, productId])
    ...
    }, [product._id,product.category,product.description,product.images,product.name,product.price,product.seller,product.stock])
